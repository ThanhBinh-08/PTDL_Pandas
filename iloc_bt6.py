...
#output
# chương trình Pandas dùng hàm .iloc[] chọn cột và hàng từ DataFrame
print("Lấy cột name and score từ DataFrame: ")
print(df.iloc[[1,3,5,7], [1,3]]) # trong đó .iloc[[hàng] , [cột]]