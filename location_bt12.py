...
#update sửa điểm hàng d cột score = 11.5. Sử dụng hàm .loc[,] để sửa điểm. Trong đó loc[hàng, cột]
# loc[]  viết tắc của từ location: vị trí 
print("Cập nhập điểm ở hàng 'd' cột score thành 11.5")
df.loc['d','score']=11.5

#output DataFrame update
print(df)